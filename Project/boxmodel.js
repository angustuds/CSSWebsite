...
function toggleNightMode() {
	...
	if (on==false) {
		...
		document.getElementById("hr7").style.backgroundColor = "black";
		...
		document.getElementById("image1").src="ImagesNight/Border.png";			//Change image
		document.getElementById("image2").src="ImagesNight/BorderSeparate.png";
		document.getElementById("image3").src="ImagesNight/BorderMixed.png";
		document.getElementById("image4").src="ImagesNight/Margins.png";
		...
		document.getElementById("hr7").style.backgroundColor = "#0A4984";
		...
		document.getElementById("image1").src="Images/Border.png";			//Change image
		document.getElementById("image2").src="Images/BorderSeparate.png";
		document.getElementById("image3").src="Images/BorderMixed.png";
		document.getElementById("image4").src="Images/Margins.png";
...
function increaseFont() {
	...
	currentsize = parseFloat(style);			//Convert to int
