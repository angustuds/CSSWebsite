...
function toggleNightMode() {
	...
	if (on==false) {
		...
		document.getElementById("image1").src="ImagesNight/InternalStyle.png";			//Change image
		document.getElementById("image2").src="ImagesNight/ExternalLink.png";
		document.getElementById("image3").src="ImagesNight/InlineStyle.png";
		...
		document.getElementById("image1").src="Images/InternalStyle.png";			//Change image
		document.getElementById("image2").src="Images/ExternalLink.png";
		document.getElementById("image3").src="Images/InlineStyle.png";
