var on = false;			//Variable to track if night mode is on
...
function toggleNightMode() {
	...
	if (on==false) {		//If night mode is off
		...
		document.body.style.color = "white";				//Change text colour
 		document.getElementById("nav").style.backgroundColor = "black";			//Change all parts of navigation bar
		...
		document.getElementById("hr1").style.backgroundColor = "black";			//Change hr colours
		document.getElementById("hr2").style.backgroundColor = "black";
		
		on = true;			//Set boolean to true
	}
	else {			//If night mode is on
		document.body.style.backgroundColor = "white";			//Change background colour
		document.body.style.color = "black";					//Change text colour
		document.getElementById("nav").style.backgroundColor = "#0A4984";			//Change all navigation bar elements colour
		...
		document.getElementById("link1").style.color = "blue";			//Change links colour
